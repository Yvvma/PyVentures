...
window.OvrwrldMaps = {
  ...
  VillageMap: {
    lowerSrc: "/images/maps/VillageMapLo.png",
    upperSrc: "/images/maps/VillageMapUp.png",
    ...
    gameObjects: {
      ...
      npc3: new Characters({
        x: utils.withGrid(6),
        y: utils.withGrid(9),
        src: "/images/characters/ch/npc3.png",
        behaveLoop: [
  ...
  LibraryIns: {
    lowerSrc: "/images/maps/LibraryInsLo.png",
    upperSrc: "/images/maps/LibraryInsUp.png",
    ...
    gameObjects: {
      ...
      npc1: new Characters({
        x: utils.withGrid(13),
        y: utils.withGrid(6),
        src: "/images/characters/ch/npc1.png",
        behaveLoop: [
          {type: "stand", direction: "down", time: 600},
      ...
      npc2: new Characters({
        x: utils.withGrid(3),
        y: utils.withGrid(6),
        src: "/images/characters/ch/npc2cut.png",
        //fix npc walk loop
        behaveLoop: [
